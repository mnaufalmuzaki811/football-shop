...
SECRET_KEY = 'django-insecure-b)4fala2%96@2k#(atsvbsrv+)f#7_pyb=cc*lj$68%@sd91#n'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "muhammad-naufal419-footballshop.pbp.cs.ui.ac.id"]
